...
ricardo.to_sql('recipe', db, if_exists='append', index=False)
print("inserted ricardo data")

marmitton.to_sql('recipe', db, if_exists='append', index=False)
print("inserted marmitton data")

septcinq.to_sql('recipe', db, if_exists='append', index=False)
print("inserted 750g data")

cuisine_az.to_sql('recipe', db, if_exists='append', index=False)
print("inserted cuisine az data")

marieclaire.to_sql('recipe', db, if_exists='append', index=False)
